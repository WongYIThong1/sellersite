        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-slate-400">
              <li><Link href="#" className="hover:text-white transition-colors">智能设备</Link></li>
              <li><Link href="#" className="hover:text-white transition-colors">时尚配饰</Link></li>
              <li><Link href="#" className="hover:text-white transition-colors">生活用品</Link></li>
              <li><Link href="#" className="hover:text-white transition-colors">户外用品</Link></li>
            </ul>
          </div>
          <div>
            ...
            <ul className="space-y-2 text-slate-400">
              ...
              <li><Link href="#" className="hover:text-white transition-colors">退换货政策</Link></li>
              <li><Link href="#" className="hover:text-white transition-colors">配送信息</Link></li>
